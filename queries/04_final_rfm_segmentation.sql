...
-- Generate a A CTE or Common Table Expression,  a temporary result set in a SQL query. 
-- Identify Quantiles that divide a set of data into equal parts.
-- segment your customers using the quantiles you generated and assign them to categories based on their RFM values.
